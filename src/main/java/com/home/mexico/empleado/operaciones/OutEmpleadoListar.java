...
@XmlRootElement(name = "Out_EmpleadoListar")
public class OutEmpleadoListar {

    @XmlElement(name = "Empleado", required = true)
    protected List<OutEmpleadoListar.Empleado> empleado;
     ...
     * {@link OutEmpleadoListar.Empleado }
     * 
     * 
     */
    public List<OutEmpleadoListar.Empleado> getEmpleado() {
        if (empleado == null) {
            empleado = new ArrayList<OutEmpleadoListar.Empleado>();
        }
    ...
    public static class Empleado {
        ...
        protected OutEmpleadoListar.Empleado.Departamento departamento;
         ...
         * @return
         *     possible object is
         *     {@link OutEmpleadoListar.Empleado.Departamento }
         *     
         */
        public OutEmpleadoListar.Empleado.Departamento getDepartamento() {
            return departamento;
        }
         ...
         *     
         */
        public void setDepartamento(OutEmpleadoListar.Empleado.Departamento value) {
